...
rspndnr + wave£ polknow1 polknow2 polkno3 polkn4 ilikecats1
...
#Wave 2
ESSclean$wave2 <- ifelse(ESS$WAVES == "All waves", 2, ifelse(ESSclean$WAVES == "Wave 1 and 2", 2, ifelse(ESSclean$WAVES == "Wave 1, 2 and 3", 2, 0)))

#Wave 3
ESSclean$wave3 <- ifelse(ESSclean$WAVES == "All waves", 3, ifelse(ESSclean$WAVES == "Wave 1, 2 and 3", 3, 0))

#Wave 4
ESSclean$wave4 <- ifelse(ESSclean$WAVES == "All waves", 4, 0)
...
Essclean2 <- ESSclean %>% mutate("Wave1" = ifelse(WAVES == "All waves" | WAVES == "Only wave 1" | WAVES == "Wave 1 and 2" | WAVES == "Waves 1, 2 and 3", 1, 0))
