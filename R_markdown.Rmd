...
ESSclean <- ESS %>%
  count(WAVES) #First count the number of respondents participating in each level of 'WAVES'.

#Wave 1
ESSclean$wave1 <- ifelse(ESSclean$WAVES == "All waves", 1, ifelse(ESSclean$WAVES == "Only wave 1", 1, ifelse(ESSclean$WAVES == "Wave 1 and 2", 1, ifelse(ESSclean$WAVES == "Wave 1, 2 and 3", 1, 0)))) 
#Create new column called "wave1" in ESSclean, assign the value 1 = YES 0 = NO. (Note all participants were in at least wave1) 

#Wave 2
ESSclean$wave2 <- ifelse(ESS$WAVES == "All waves", 1, ifelse(ESSclean$WAVES == "Wave 1 and 2", 2, ifelse(ESSclean$WAVES == "Wave 1, 2 and 3", 1, 0))) #Create new column called "wave2" in ESSclean, assign the value 1 = YES if respondent participated in wave 2, 0 = NO. 

#Wave 3
ESSclean$wave3 <- ifelse(ESSclean$WAVES == "All waves", 1, ifelse(ESSclean$WAVES == "Wave 1, 2 and 3", 1, 0)) 
#Create new column called "wave3" in ESSclean, assign the value 1 = YES if respondent participated in wave 3, 0 = NO. 

#Wave 4
ESSclean$wave4 <- ifelse(ESSclean$WAVES == "All waves", 1, 0) #Create new column called "wave4" in ESSclean, assign the value 1 = YES if respondent participated in wave 4, 0 = NO.
...
#tidy columns respondent ID and Waves
ESSclean %>% count(WAVES) #First count the number of respondents participating in each level of 'WAVES'.
...
#Wave 2
ESSclean$wave2 <- ifelse(ESS$WAVES == "All waves", 2, ifelse(ESSclean$WAVES == "Wave 1 and 2", 2, ifelse(ESSclean$WAVES == "Wave 1, 2 and 3", 2, 0))) #Create new column called "wave2" in ESSclean, assign the value 1 = YES if respondent participated in wave 2, 0 = NO. 

#Wave 3
ESSclean$wave3 <- ifelse(ESSclean$WAVES == "All waves", 3, ifelse(ESSclean$WAVES == "Wave 1, 2 and 3", 3, 0)) 
#Create new column called "wave3" in ESSclean, assign the value 1 = YES if respondent participated in wave 3, 0 = NO. 

#Wave 4
ESSclean$wave4 <- ifelse(ESSclean$WAVES == "All waves", 4, 0) #Create new column called "wave4" in ESSclean, assign the value 1 = YES if respondent participated in wave 4, 0 = NO. 

ESSclean %>% 
  count(wave1, wave2, wave3, wave4)
=======
...
ESSclean$WAVES <- NULL
ESSclean$Wave <- NULL
>>>>>>> 3a406088c54b2ffa45a5eca7a3629b51feeed05d
