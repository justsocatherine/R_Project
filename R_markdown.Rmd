...
#Remove columns WAVES and Wave columns
ESSclean$WAVES <- NULL
ESSclean$Wave <- NULL
...
ESSclean <- ESSclean %>% gather(delete, PolKnowl1value, w1_q18, w2_q14, w3_q19, w4_q21, na.rm = TRUE, convert = FALSE, factor_key = FALSE)
