...
# Below is work of Matteo (?)
ESSclean <- ESSclean %>% 
  group_by(RESPNR, Wavevalue) %>%
  summarise()

head(ESSclean)

ESSclean <- ESSclean %>%
  gather(key = "delete", value = "PK1", w1_q18, w2_q14, w3_q19, w4_q21, na.rm = FALSE,
convert = FALSE, factor_key = FALSE)

gather(delete, PolKnowl1value, w1_q18, w2_q14, w3_q19, w4_q21, na.rm = TRUE, convert = FALSE, factor_key = FALSE) %>% View()

ESSclean %>% select(RESPNR, delete, PolKnowl1value)
